...
def parse_rec(filename):
    ...
    for obj in tree.findall("object"):
        ...
        if obj_struct["name"] == '1' or obj_struct["name"] == '2':
...
if __name__ == '__main__':
    rec, prec, ap = voc_eval('data/drone/{0}.txt', 'data/drone/anno/uav0000137_00458_v/{0}.xml', 'data/drone/img_set.txt', 'pedestrian')
    print(rec, prec, ap)
