...
IPHONEOS_DEPLOYMENT_TARGET='12.1'  # default, can be changed via command line options or environment variable
...
class Builder:
    def __init__(self, opencv, contrib, dynamic, bitcodedisabled, exclude, build_list, disable, enablenonfree, targets, debug, debug_info):
    ...
    def getCMakeArgs(self, arch, target):
        ...
        if len(self.build_list) > 0:
            args += ["-DBUILD_LIST={}".format(self.build_list)] 
...
if __name__ == "__main__":
    ...
    parser.add_argument('--build_list', metavar='BUILDLIST', required=True, help='OpenCV set options to compile some modules only')
    ...
    # b = iOSBuilder(args.opencv, args.contrib, args.dynamic, args.bitcodedisabled, args.without, args.build_list, args.disable, args.enablenonfree,
    #     [
